    ...
    <body>
        <div class="container-fluid .content-body">
            ...
            <div class="row content-first-block">
                <div class="col-md-7 col-one-first-block">
                    <div align="center" class="col-md-12">
                        <h1>Última Notícia</h1>
                    </div>
                    <div class="row">
                        <div class="col-md-7 cfi-first">
                            <h1>Título da Notícia</h1>
                            <p style="font-size: 15px">21/05/2020 por João Vítor Batistella</p>
                            <p class="retreat"></p>
                            <p style="font-size: 15px"><storng>Fonte:</strong> Rede Crinet</p>
                        </div>
                        <div class="col-md-5 cfi-second">
                            <img src="{{asset('images/teste.jpg')}}" />
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-two-first-block">
                    <div class="row">
                        <div class="col-md-12 player-frame">
                            <iframe width="100%" height="500px" src="https://www.youtube.com/embed/gHhj3JNQKCo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row read-about">
                <div align="center" class="col-md-12">
                    <h1 style="color: white">Leia mais:</h1>
                </div>
            </div>
